...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "myGWTapp" because\n';
  ...
  $wnd.__gwt_activeModules['myGWTapp'] = {
    'moduleName' : 'myGWTapp',
    'bindings' : function() {
      return {};
    }
 ...
 * "/myGWTapp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['myGWTapp'].superdevmode = true;

  var expectedSuffix = '/myGWTapp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + myGWTapp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:myGWTapp';
  var devModeSessionKey = '__gwtDevModeSession:myGWTapp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/myGWTapp/myGWTapp.nocache.js';
  ...
  $wnd.__gwt_activeModules['myGWTapp'].canRedirect = true;
  $wnd.__gwt_activeModules['myGWTapp'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/myGWTapp?user.agent=' + ua + '&_callback=' + callback;
