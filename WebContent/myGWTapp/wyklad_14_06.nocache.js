...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "wyklad_14_06" because\n';
  ...
  $wnd.__gwt_activeModules['wyklad_14_06'] = {
    'moduleName' : 'wyklad_14_06',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/wyklad_14_06.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['wyklad_14_06'].superdevmode = true;

  var expectedSuffix = '/wyklad_14_06.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + wyklad_14_06 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:wyklad_14_06';
  var devModeSessionKey = '__gwtDevModeSession:wyklad_14_06';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/wyklad_14_06/wyklad_14_06.nocache.js';
  ...
  $wnd.__gwt_activeModules['wyklad_14_06'].canRedirect = true;
  $wnd.__gwt_activeModules['wyklad_14_06'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING wyklad_14_06';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/wyklad_14_06?user.agent=' + ua + '&_callback=' + callback;
